...
public class Chatdapter extends RecyclerView.Adapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (messagemodel.get(position).getuId().equals(FirebaseAuth.getInstance().getUid().toString())){
...
//            SenderRoom viewHolder = (SenderRoom) holder;

//            if (messagesmodel.getMessage().equals("photo")){
//
////                viewHolder.senderimage.setVisibility(View.VISIBLE);
////                viewHolder.sendermessage.setVisibility(View.GONE);
////                Glide.with(context).load(messagesmodel.getImageurl()).into(viewHolder.senderimage);
//
//            }
        }
        else {
...
//        ActivityChattingDetailsBinding binding;
        ...
        public SenderRoom(@NonNull View itemView) {
            super(itemView);
//            binding = ActivityChattingDetailsBinding.bind(itemView);
