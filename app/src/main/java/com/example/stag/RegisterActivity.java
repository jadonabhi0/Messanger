    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!binding.remail.getText().toString().matches(regex) || binding.remail.getText().toString().isEmpty()) {
                    binding.remail.setError("Enter your email");
                        return;

                    }

                    if (binding.rpassword.getText().toString().isEmpty()){
                        binding.rpassword.setError("Enter password");
                        return;
                    }
